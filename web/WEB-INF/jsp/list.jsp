<%@ page import="by.yakovtsev.webapp.WebAppConfig" %>
<%@ page import="by.yakovtsev.webapp.model.ContactType" %>
<%@ page import="by.yakovtsev.webapp.model.Resume" %>
            ...
            <td>
                <table border="1" cellpadding="8" cellspacing="0">
                    ...
                    <c:forEach items="${resumeList}" var="resume">
                        <jsp:useBean id="resume" type="by.yakovtsev.webapp.model.Resume"/>
                        <tr>
