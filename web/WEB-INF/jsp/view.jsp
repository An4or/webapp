<%@ page import="by.yakovtsev.webapp.model.*" %>
<%@ page import="by.yakovtsev.webapp.web.HtmlUtil" %>
...
<head>
    ...
    <jsp:useBean id="resume" type="by.yakovtsev.webapp.model.Resume" scope="request"/>
...
<section>
    ...
    <p>
        <c:forEach var="type" items="${resume.contacts.keySet()}">
            <jsp:useBean id="type" type="by.yakovtsev.webapp.model.ContactType"/>
        ...
        %>
            ...
            <c:forEach var="org" items="<%=((OrganizationSection) entry.getValue()).getValues()%>">
                ...
                <c:forEach var="period" items="${org.periods}">
                    <jsp:useBean id="period" type="by.yakovtsev.webapp.model.Organization.Period"/>
                    <tr>
